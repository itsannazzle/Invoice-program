 ...
 * @author ASUS
 */
public class editDataSupplier extends javax.swing.JFrame {
    Connection c;
    /**
    ...
    public editDataSupplier() {
        try {
            ...
            Logger.getLogger(editDataSupplier.class.getName()).log(Level.SEVERE, null, ex);
        }
        initComponents();
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
            ...
            try{
                ...
                PreparedStatement ps = c.prepareStatement("UPDATE datasupplier SET sup_nama=?,sup_email=?,sup_tel=?,sup_alamat=? WHERE sup_id=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editDataSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editDataSupplier().setVisible(true);
            }
        });
    }
